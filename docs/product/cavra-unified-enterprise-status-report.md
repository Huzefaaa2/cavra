...
| Future roadmap | Closed unless product scope changes | Use the [roadmap intake gate](../roadmap-intake-gate.md), [roadmap candidate charter](../roadmap-candidate-charter.md), [future phase opening gate](../roadmap-future-phase-opening-gate.md), [future phase registry](../roadmap-future-phase-registry.md), [future work governance index](../roadmap-future-work-governance-index.md), and [roadmap governance quickcheck](../roadmap-governance-quickcheck.md) before adding rows. Add new rows only for a new API, CLI command, validator family, connector, deployment target, AISPM capability, evidence schema, trust artifact, edition, packaging model, or buyer-facing surface. |
...
- Managed and Enterprise operating bridges: live validation plan, cutover runbook, stabilization report, steady-state handoff, operating release index, operating announcement, one-pass operating chain validation, operating release certificate, and certificate publication index for customer-safe transition into normal operations.
...
python3 scripts/validate_roadmap_future_work_governance_index.py --require-live
python3 scripts/validate_roadmap_governance_quickcheck.py --repo-root . --require-live
...
15. Run the [CAVRA Roadmap Future Work Governance Index](../roadmap-future-work-governance-index.md) to validate the full future-work governance chain in one pass.
16. Run the [CAVRA Roadmap Governance Quickcheck](../roadmap-governance-quickcheck.md) before publishing roadmap status or opening a future phase.
17. Keep repeated monitoring and customer-success cycles out of the public roadmap unless they create a new CAVRA product capability.
