...
| R1.3 | 1 | P6, P12 | Produce signed releases, SBOMs, provenance, and repeatable release attestations. | R1.2 | In Progress | Release security validators and release-trust checklist exist; full SBOM/signing enforcement across every release workflow remains next. | `python3 scripts/validate_release_security.py`; release workflow evidence review. | `docs/release-trust-checklist.md`, `docs/release-signing-operations.md`, `.github/workflows/go-release.yml`. |
