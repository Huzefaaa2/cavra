...
- AI Posture, policy, evidence, integrations, compliance, use-case,
  ...
  guidance, replay-to-policy CI gate setup paths and readiness export actions, and copy/download JSON export actions by agent, repository, and
  control surface;
