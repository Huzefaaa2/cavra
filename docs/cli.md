...
cavra release deliver-endpoint-remediation-sla .cavra/release/endpoint-remediation-sla/endpoint-remediation-sla-report.json --config .cavra/connectors.json --provider all --metadata-json .cavra/evidence/metadata.json --json
