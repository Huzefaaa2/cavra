...
cavra release reconcile-endpoint-deployment go/cavra-runtime/dist/go-runtime-v0.2.0-rc.1 .cavra/release/observed-endpoints.json --metadata-json .cavra/evidence/metadata.json --json
