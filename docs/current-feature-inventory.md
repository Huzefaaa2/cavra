...
Known gaps: packaged Go backend, hosted sandbox deployment, policy-pack approval/signature write-back workflow, and vendor-specific hooks beyond the MCP/CLI path and generated CI/CD templates.
