...
Brand assets: `assets/brand/` contains CAVRA SVG logos, favicons, social thumbnails, and PNG exports for documentation, README, dashboard, and social preview usage. The sandbox console uses the compact mark in navigation, a larger top-right hero mark below the install CTA, and ships the brand assets in the Pages artifact.
