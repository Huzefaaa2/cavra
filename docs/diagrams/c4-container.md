...
System_Boundary(cavra, "CAVRA") {
  ...
  Container(goRuntime, "Go Enforcement Plane", "Go", "Scaffolded low-latency enforcement backend with compiled-policy loading, generated contracts, shared Python/Go parity fixtures, and CI checks; daemon transport remains next.")
}
