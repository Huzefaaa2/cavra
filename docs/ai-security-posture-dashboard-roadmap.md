...
drift detection, tool-chain risk graphing, agent blast-radius mapping, control coverage heatmap views, and a public-safe sandbox portal.
...
- Add public-safe behavior fingerprints, policy context gaps, pre-action risk
  forecasts, intent-to-action drift, tool-chain risk graphing, agent blast-radius mapping, and control coverage heatmap views derived from
