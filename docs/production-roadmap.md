...
Next recommended implementation phase: add release package channel manifests and updater policy for managed developer workstations.
...
- Add release package channel manifests and updater policy for managed developer workstations.
