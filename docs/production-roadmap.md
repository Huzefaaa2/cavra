...
- Signed Go release package workflow. Delivered with checksums, SPDX-style SBOM, detached Ed25519 signatures when configured, release evidence, GitHub Release asset attachment, and verifier CLI support.
