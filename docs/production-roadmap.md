...
Next recommended implementation phase: add endpoint drift remediation plans with approval-bound republish and rollback workflows.
...
- Convert endpoint reconciliation drift findings into remediation plans.
- Require approval before republishing endpoint exports or rolling back runtime versions.
- Add API, CLI, and console views for remediation status and evidence links.
