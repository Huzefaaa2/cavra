...
The public Community maintenance-release evidence path is ready for a future
v0.1.1 release. Artifact checksum and install-smoke evidence must wait until a
real tag and release artifacts are published.
