...
- Go tests for contract handling and compiled-policy-backed evaluation.
...
Add a client helper, lifecycle management, evidence hooks, and expanded parity for approvals and registry-backed MCP decisions.
