...
Next recommended implementation phase: add deployment templates for scheduled recurrence automation workers.
...
- Add a GitHub Actions scheduled workflow template for dry-run recurrence automation and guarded execute mode.
- Add Kubernetes CronJob and systemd timer references for self-hosted recurrence automation.
- Document connector configuration, secret handling, rollback, and disable procedures for scheduled workers.
