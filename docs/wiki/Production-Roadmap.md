...
dashboard. The Enterprise roadmap tracks live agent observability, prompts,
...
centralized retention, compliance exports, and control-plane actions.
...
forecasts, intent-to-action drift, tool-chain risk graphing, agent blast-radius mapping, and control coverage heatmap views through
...
`/aispm/pre-action-risk-forecasts`, `/aispm/intent-action-drift`, `/aispm/tool-chain-graph`, `/aispm/agent-blast-radius`, and `/aispm/control-coverage-heatmap`;
...
correlation, raw tool payload graphing, public-safe agent blast-radius and control coverage heatmap rollups, private topology enrichment, cross-system execution traces, private IdP/RBAC context, and control-plane actions.
...
Community release readiness dashboard validation is now documented at
`docs/community-release-readiness-dashboard-validation.md` and enforced by
...
Community v0.1.2 release notes and verification evidence are documented
at `docs/releases/community-v0.1.2.md` and
`docs/release-verifications/community-v0.1.2-maintenance-verification.md`.
Published Community v0.1.2 post-release verification is documented at
...
Community v1.0.0 release-candidate hardening is documented at
`docs/community-v1.0.0-release-candidate-hardening.md` and enforced by
...
Community v1.0.0 GA readiness is documented at
`docs/community-v1.0.0-ga-readiness.md`, recorded in
`docs/release-verifications/community-v1.0.0-ga-readiness.json`, and enforced
by `scripts/validate-community-v100-ga-readiness.py`.
Community v1.0.0 GA publication package preparation is documented at
