...
recommended next PR is the public tenant audit-store operating contract,
followed by billing/subscription boundary documentation, private operating
evidence, and public docs/wiki sync.
