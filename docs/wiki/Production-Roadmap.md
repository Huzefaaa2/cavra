...
Next recommended implementation phase: add acknowledgement audit delivery history filters and delivery health dashboards.
...
- Add history filters for acknowledgement audit delivery plans and connector delivery sources.
- Add delivery health dashboard cards for scheduled acknowledgement audit exports.
