...
| Future roadmap | Closed unless product scope changes | Use the [roadmap intake gate](../roadmap-intake-gate.md), [roadmap candidate charter](../roadmap-candidate-charter.md), [future phase opening gate](../roadmap-future-phase-opening-gate.md), [future phase registry](../roadmap-future-phase-registry.md), and [future work governance index](../roadmap-future-work-governance-index.md) before adding rows. Add new rows only for a new API, CLI command, validator family, connector, deployment target, AISPM capability, evidence schema, trust artifact, edition, packaging model, or buyer-facing surface. |
...
16. Keep repeated monitoring and customer-success cycles out of the public roadmap unless they create a new CAVRA product capability.
