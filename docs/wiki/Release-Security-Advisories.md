...
3. Confirm the package contains `checksums.txt`, `cavra-runtime.sbom.spdx.json`, `cavra-runtime.provenance.intoto.json`, detached signatures, and release evidence.
