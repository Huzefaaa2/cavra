...
normalized local activity metadata.
...
enrichment, private asset/dependency/identity forecast enrichment, private
IdP/RBAC context, and commercial compliance exports.
