...
See [Enterprise Live Identity Validation](Enterprise-Live-Identity-Validation.md) for the packet format and [Enterprise Identity R2.1 Closeout](Enterprise-Identity-R2.1-Closeout.md) for the completion boundary.
