...
Add governed rollout evidence artifact retrieval for managed endpoint deployment records and continue broadening approval-route parity as new policy packs are added.
