...
- `/deployment/production-readiness` and the Evidence Console Production Readiness panel now surface Go backend pilot, deployment, promotion, rollback, and rehearsal status.
