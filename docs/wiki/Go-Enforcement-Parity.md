...
Add managed endpoint deployment manifests for CI runners and developer workstations and continue broadening approval-route parity as new policy packs are added.
