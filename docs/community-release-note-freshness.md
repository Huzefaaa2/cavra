...
The freshness validator runs in Community CI, security scan, release-community,
and `cavra-required-check` so stale release notes block public release work.

## Boundary Rules

This validator checks public Community release documentation only. It does not
inspect private Enterprise packages, paid policy packs, SaaS backend artifacts,
license-service internals, customer records, private registry credentials, or
