...
- Recurrence Operations panel for endpoint remediation retry plans, owner digest evidence, suppression trend analytics, owner/provider/action/category filters, JSON detail views, and local export drill-downs.
