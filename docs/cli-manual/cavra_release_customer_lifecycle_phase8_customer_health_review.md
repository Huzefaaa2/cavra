...
`cavra release customer-lifecycle-phase8-customer-health-review` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-customer-health-review --help
```
