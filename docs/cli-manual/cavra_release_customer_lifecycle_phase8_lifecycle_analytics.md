...
`cavra release customer-lifecycle-phase8-lifecycle-analytics` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-lifecycle-analytics --help
```
