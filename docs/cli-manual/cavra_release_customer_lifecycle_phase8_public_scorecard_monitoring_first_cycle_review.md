...
`cavra release customer-lifecycle-phase8-public-scorecard-monitoring-first-cycle-review` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-monitoring-first-cycle-review --help
```
