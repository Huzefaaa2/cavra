...
`cavra release customer-lifecycle-phase8-support-automation` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-support-automation --help
```
