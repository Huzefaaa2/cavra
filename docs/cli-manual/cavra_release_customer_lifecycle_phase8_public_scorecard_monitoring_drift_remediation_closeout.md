...
`cavra release customer-lifecycle-phase8-public-scorecard-monitoring-drift-remediation-closeout` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-monitoring-drift-remediation-closeout --help
```
