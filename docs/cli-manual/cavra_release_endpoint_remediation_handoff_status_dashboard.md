...
`cavra release endpoint-remediation-handoff-status-dashboard` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release endpoint-remediation-handoff-status-dashboard --help
```
