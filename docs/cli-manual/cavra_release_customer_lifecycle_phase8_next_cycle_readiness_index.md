...
`cavra release customer-lifecycle-phase8-next-cycle-readiness-index` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-next-cycle-readiness-index --help
```
