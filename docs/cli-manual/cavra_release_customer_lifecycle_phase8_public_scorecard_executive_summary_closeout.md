...
`cavra release customer-lifecycle-phase8-public-scorecard-executive-summary-closeout` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-executive-summary-closeout --help
```
