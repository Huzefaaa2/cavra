...
`cavra release customer-lifecycle-phase8-public-scorecard-operating-loop-index` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-operating-loop-index --help
```
