...
`cavra release customer-lifecycle-phase8-action-followup-checkpoint` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-action-followup-checkpoint --help
```
