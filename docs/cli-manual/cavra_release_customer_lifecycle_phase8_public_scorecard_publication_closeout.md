...
`cavra release customer-lifecycle-phase8-public-scorecard-publication-closeout` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-publication-closeout --help
```
