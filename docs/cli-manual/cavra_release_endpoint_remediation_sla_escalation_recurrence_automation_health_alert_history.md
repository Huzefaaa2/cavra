...
`cavra release endpoint-remediation-sla-escalation-recurrence-automation-health-alert-history` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release endpoint-remediation-sla-escalation-recurrence-automation-health-alert-history --help
```
