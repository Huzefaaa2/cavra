...
`cavra release customer-lifecycle-phase8-public-scorecard-distribution-audit-index` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-distribution-audit-index --help
```
