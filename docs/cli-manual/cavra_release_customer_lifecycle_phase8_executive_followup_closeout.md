...
`cavra release customer-lifecycle-phase8-executive-followup-closeout` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-executive-followup-closeout --help
```
