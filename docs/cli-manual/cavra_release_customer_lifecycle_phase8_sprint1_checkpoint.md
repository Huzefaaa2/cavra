...
`cavra release customer-lifecycle-phase8-sprint1-checkpoint` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-sprint1-checkpoint --help
```
