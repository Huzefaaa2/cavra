...
`cavra release endpoint-remediation-handoff-status-history` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release endpoint-remediation-handoff-status-history --help
```
