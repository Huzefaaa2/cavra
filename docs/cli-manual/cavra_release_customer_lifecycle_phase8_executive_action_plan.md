...
`cavra release customer-lifecycle-phase8-executive-action-plan` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-executive-action-plan --help
```
