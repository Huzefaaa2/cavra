...
`cavra release managed-enterprise-certificate-publication-index` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release managed-enterprise-certificate-publication-index --help
```
