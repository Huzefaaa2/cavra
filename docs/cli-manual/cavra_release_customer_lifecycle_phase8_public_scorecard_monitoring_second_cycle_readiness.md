...
`cavra release customer-lifecycle-phase8-public-scorecard-monitoring-second-cycle-readiness` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-monitoring-second-cycle-readiness --help
```
