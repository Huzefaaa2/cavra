...
`cavra release customer-lifecycle-phase8-public-scorecard-monitoring-activation-closeout` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-monitoring-activation-closeout --help
```
