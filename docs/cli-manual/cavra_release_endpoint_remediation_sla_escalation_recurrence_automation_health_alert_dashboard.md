...
`cavra release endpoint-remediation-sla-escalation-recurrence-automation-health-alert-dashboard` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release endpoint-remediation-sla-escalation-recurrence-automation-health-alert-dashboard --help
```
