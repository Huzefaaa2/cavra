...
`cavra release customer-lifecycle-phase8-public-scorecard-distribution-readiness` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-distribution-readiness --help
```
