...
`cavra release customer-lifecycle-phase8-public-scorecard-monitoring-second-cycle-first-review` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-monitoring-second-cycle-first-review --help
```
