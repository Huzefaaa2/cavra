...
`cavra release customer-lifecycle-phase8-public-scorecard-distribution-closeout` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-distribution-closeout --help
```
