...
`cavra release customer-lifecycle-phase8-public-scorecard-refresh-checkpoint` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-refresh-checkpoint --help
```
