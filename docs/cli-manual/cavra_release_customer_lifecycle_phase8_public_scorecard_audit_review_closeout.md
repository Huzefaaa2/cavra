...
`cavra release customer-lifecycle-phase8-public-scorecard-audit-review-closeout` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-public-scorecard-audit-review-closeout --help
```
