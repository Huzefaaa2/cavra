...
`cavra release customer-lifecycle-phase8-executive-health-rollup` - generated CAVRA CLI manual page.

## Synopsis

```bash
cavra release customer-lifecycle-phase8-executive-health-rollup --help
```
