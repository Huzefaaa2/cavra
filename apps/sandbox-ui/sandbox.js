const navItems = [
  ...
  { id: "first-run-setup", label: "First-Run Setup", icon: "S", group: "Start", description: "Default workspace, policy actions, SMTP setup, validation, and first-launch operator flow." },
