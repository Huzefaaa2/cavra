...
The canonical production roadmap is maintained in
[docs/production-roadmap.md](docs/production-roadmap.md).

Current open-core priority:

1. Keep this public repository as CAVRA Community Edition.
2. Keep Enterprise source, paid policy packs, license server, SaaS backend, and
...
15. Private hosted policy registry readiness evidence is delivered in
   `cavra-enterprise` PR #67.
16. Private tenant audit-store operating evidence is delivered in
   `cavra-enterprise` PR #68.
17. Private SaaS operating readiness rollup evidence is delivered in
...
45. Private conversion renewal outcome rollup evidence is delivered in
   `cavra-enterprise` PR #95 and public-safe sync is documented in
   [docs/trial-conversion-renewal-outcome-rollup-sync.md](docs/trial-conversion-renewal-outcome-rollup-sync.md).
46. Private final commercial renewal closeout package evidence is delivered in
   `cavra-enterprise` PR #96 and public-safe sync is documented in
   [docs/trial-final-commercial-renewal-closeout-sync.md](docs/trial-final-commercial-renewal-closeout-sync.md).
47. Private trial commercialization closure readiness summary evidence is
   delivered in `cavra-enterprise` PR #97 and public-safe sync is documented in
   [docs/trial-commercialization-closure-readiness-sync.md](docs/trial-commercialization-closure-readiness-sync.md).
...
54. Private commercial launch-readiness executive review evidence is delivered
   in `cavra-enterprise` PR #104 and public-safe sync is documented in
   [docs/trial-commercial-launch-readiness-executive-review-sync.md](docs/trial-commercial-launch-readiness-executive-review-sync.md).
...
60. Private release retrospective and roadmap intake evidence is delivered in
   `cavra-enterprise` PR #110 and public-safe sync is documented in
   [docs/trial-release-retrospective-roadmap-intake-sync.md](docs/trial-release-retrospective-roadmap-intake-sync.md).
61. Next recommendation: add private final launch retrospective closeout
   evidence, then sync public docs with public-safe executive-acceptance,
   product-planning, customer-success-follow-up, renewal-expansion-action,
   support-trend-closure, and final-archive gates.
