...
- [Community AISPM v1.0 release notes](docs/releases/community-v1.0.0-aispm.md)
...
- [AISPM Phase B closeout verification](docs/aispm-phase-b-closeout-verification.md)
...
- [AISPM Report Center Enterprise readiness checklist](docs/architecture/aispm-report-center-enterprise-readiness.md)
- [AISPM report delivery public contract](src/cavra/schemas/aispm-report-delivery-contract.schema.json)
- [AISPM report setup wizard public contract](src/cavra/schemas/aispm-report-setup-wizard-contract.schema.json)
- [AISPM report delivery audit event public contract](src/cavra/schemas/aispm-report-delivery-audit-event.schema.json)
- [AISPM report operations dashboard public contract](src/cavra/schemas/aispm-report-operations-dashboard.schema.json)
- [AISPM report retention lifecycle public contract](src/cavra/schemas/aispm-report-retention-lifecycle.schema.json)
- [AISPM report search and retrieval public contract](src/cavra/schemas/aispm-report-search-retrieval.schema.json)
- [AISPM report export package manifest public contract](src/cavra/schemas/aispm-report-export-package-manifest.schema.json)
- [AISPM report schedule policy public contract](src/cavra/schemas/aispm-report-schedule-policy.schema.json)
- [AISPM report recipient policy public contract](src/cavra/schemas/aispm-report-recipient-policy.schema.json)
- [AISPM report approval decision public contract](src/cavra/schemas/aispm-report-approval-decision.schema.json)
- [AISPM report exception lifecycle public contract](src/cavra/schemas/aispm-report-exception-lifecycle.schema.json)
- [AISPM report evidence room public contract](src/cavra/schemas/aispm-report-evidence-room.schema.json)
- [AISPM report evidence room access event public contract](src/cavra/schemas/aispm-report-evidence-room-access-event.schema.json)
- [AISPM report incident packet public contract](src/cavra/schemas/aispm-report-incident-packet.schema.json)
- [AISPM report incident closure public contract](src/cavra/schemas/aispm-report-incident-closure.schema.json)
- [AISPM report KPI metrics public contract](src/cavra/schemas/aispm-report-kpi-metrics.schema.json)
- [AISPM report alert escalation public contract](src/cavra/schemas/aispm-report-alert-escalation.schema.json)
- [AISPM report alert operations dashboard public contract](src/cavra/schemas/aispm-report-alert-operations-dashboard.schema.json)
- [AISPM report alert drilldown public contract](src/cavra/schemas/aispm-report-alert-drilldown.schema.json)
- [AISPM report alert remediation plan public contract](src/cavra/schemas/aispm-report-alert-remediation-plan.schema.json)
- [AISPM report alert remediation closure public contract](src/cavra/schemas/aispm-report-alert-remediation-closure.schema.json)
- [AISPM report remediation closure operations dashboard public contract](src/cavra/schemas/aispm-report-remediation-closure-operations-dashboard.schema.json)
- [AISPM report remediation closure executive digest public contract](src/cavra/schemas/aispm-report-remediation-closure-executive-digest.schema.json)
- [AISPM report remediation closure digest distribution public contract](src/cavra/schemas/aispm-report-remediation-closure-digest-distribution.schema.json)
- [AISPM Report Center Enterprise Trial validation packet public contract](src/cavra/schemas/aispm-report-center-trial-validation-packet.schema.json)
- [AISPM Report Center trial operator dashboard readiness public contract](src/cavra/schemas/aispm-report-center-trial-operator-dashboard-readiness.schema.json)
...
- AISPM report catalog portal packet: `cavra-aispm-report-catalog-packet.json`
- [AISPM report delivery setup readiness](docs/release-verifications/aispm-report-delivery-setup-readiness.md)
- [AISPM report delivery setup readiness JSON](docs/release-verifications/aispm-report-delivery-setup-readiness.json)
- AISPM report delivery setup readiness validator: `scripts/validate-aispm-report-delivery-setup-readiness.py`
- AISPM report delivery setup portal packet: `cavra-aispm-report-delivery-setup-packet.json`
- [AISPM report operations readiness](docs/release-verifications/aispm-report-operations-readiness.md)
- [AISPM report operations readiness JSON](docs/release-verifications/aispm-report-operations-readiness.json)
- AISPM report operations readiness validator: `scripts/validate-aispm-report-operations-readiness.py`
- AISPM report operations readiness portal packet: `cavra-aispm-report-operations-readiness-packet.json`
- [AISPM report governance readiness](docs/release-verifications/aispm-report-governance-readiness.md)
- [AISPM report governance readiness JSON](docs/release-verifications/aispm-report-governance-readiness.json)
- AISPM report governance readiness validator: `scripts/validate-aispm-report-governance-readiness.py`
- AISPM report governance readiness portal packet: `cavra-aispm-report-governance-readiness-packet.json`
- [AISPM report assurance readiness](docs/release-verifications/aispm-report-assurance-readiness.md)
- [AISPM report assurance readiness JSON](docs/release-verifications/aispm-report-assurance-readiness.json)
- AISPM report assurance readiness validator: `scripts/validate-aispm-report-assurance-readiness.py`
- AISPM report assurance readiness portal packet: `cavra-aispm-report-assurance-readiness-packet.json`
- [AISPM report response readiness](docs/release-verifications/aispm-report-response-readiness.md)
- [AISPM report response readiness JSON](docs/release-verifications/aispm-report-response-readiness.json)
- AISPM report response readiness validator: `scripts/validate-aispm-report-response-readiness.py`
- AISPM report response readiness portal packet: `cavra-aispm-report-response-readiness-packet.json`
- [AISPM report trial operations readiness](docs/release-verifications/aispm-report-trial-operations-readiness.md)
- [AISPM report trial operations readiness JSON](docs/release-verifications/aispm-report-trial-operations-readiness.json)
- AISPM report trial operations readiness validator: `scripts/validate-aispm-report-trial-operations-readiness.py`
- AISPM report trial operations readiness portal packet: `cavra-aispm-report-trial-operations-readiness-packet.json`
- [AISPM pilot control readiness](docs/release-verifications/aispm-pilot-control-readiness.md)
- [AISPM pilot control readiness JSON](docs/release-verifications/aispm-pilot-control-readiness.json)
- AISPM pilot control readiness validator: `scripts/validate-aispm-pilot-control-readiness.py`
- AISPM pilot control readiness portal packet: `cavra-aispm-pilot-control-readiness-packet.json`
- [AISPM launch readiness rollup](docs/release-verifications/aispm-launch-readiness-rollup.md)
- [AISPM launch readiness rollup JSON](docs/release-verifications/aispm-launch-readiness-rollup.json)
- AISPM launch readiness validator: `scripts/validate-aispm-launch-readiness.py`
- [Hosted sandbox Pages smoke validation](docs/release-verifications/hosted-sandbox-pages-smoke-validation.md)
- [Hosted sandbox Pages smoke validation JSON](docs/release-verifications/hosted-sandbox-pages-smoke-validation.json)
- Hosted sandbox Pages browser validator: `scripts/validate-hosted-sandbox-pages.mjs`
- [Hosted sandbox deployment freshness](docs/release-verifications/hosted-sandbox-deployment-freshness.md)
- [Hosted sandbox deployment freshness JSON](docs/release-verifications/hosted-sandbox-deployment-freshness.json)
- Hosted sandbox deployment freshness validator: `scripts/validate-hosted-sandbox-deployment-freshness.py`
- Hosted sandbox build sentinel: `community-v1.0.0-aispm-release-evidence-index`
- [Hosted sandbox operator release status](docs/release-verifications/hosted-sandbox-operator-release-status.md)
- [Hosted sandbox operator release status JSON](docs/release-verifications/hosted-sandbox-operator-release-status.json)
- Hosted sandbox operator release status validator: `scripts/validate-hosted-sandbox-operator-status.py`
- Hosted sandbox operator status portal packet: `cavra-hosted-sandbox-operator-status-packet.json`
- [Hosted sandbox post-deploy evidence contract](docs/release-verifications/hosted-sandbox-post-deploy-evidence.md)
- [Hosted sandbox post-deploy evidence contract JSON](docs/release-verifications/hosted-sandbox-post-deploy-evidence.json)
- Hosted sandbox post-deploy evidence generator: `scripts/generate-hosted-sandbox-deploy-evidence.py`
- Hosted sandbox post-deploy evidence validator: `scripts/validate-hosted-sandbox-deploy-evidence.py`
- Hosted sandbox post-deploy artifact: `cavra-hosted-sandbox-post-deploy-evidence`
...
cavra aispm validate-review-packet cavra-replay-policy-review-packet.json
...
Policy authoring and rollout workflows are exposed through `/policy-pack-catalog`, `/policy-packs/draft`, `/policy-rollouts/change-plan`, and `/policy-rollouts/apply-change`. AISPM replay-to-policy review packet validation is exposed through `/aispm/replay-to-policy-review-packet/validate` and the CLI command `cavra aispm validate-review-packet`. AISPM CI gate readiness validation is exposed through `/aispm/replay-to-policy-ci-gate-readiness/validate` and `cavra aispm validate-ci-gate-readiness`. Production deployment validation is exposed through `/deployment/production-readiness`.
...
Hosted operator release status is tracked by [Hosted sandbox operator release status](docs/release-verifications/hosted-sandbox-operator-release-status.md), [Hosted sandbox operator release status JSON](docs/release-verifications/hosted-sandbox-operator-release-status.json), and `scripts/validate-hosted-sandbox-operator-status.py`; the AISPM portal exports `cavra-hosted-sandbox-operator-status-packet.json` for release reviewers.

AISPM report catalog readiness is tracked by [AISPM report catalog readiness](docs/release-verifications/aispm-report-catalog-readiness.md), [AISPM report catalog readiness JSON](docs/release-verifications/aispm-report-catalog-readiness.json), and `scripts/validate-aispm-report-catalog-readiness.py`; the AISPM portal exports `cavra-aispm-report-catalog-packet.json` to show which reports Community can download and which report rendering, scheduling, email, and signed package capabilities require Enterprise.

AISPM report delivery setup readiness is tracked by [AISPM report delivery setup readiness](docs/release-verifications/aispm-report-delivery-setup-readiness.md), [AISPM report delivery setup readiness JSON](docs/release-verifications/aispm-report-delivery-setup-readiness.json), and `scripts/validate-aispm-report-delivery-setup-readiness.py`; the AISPM portal exports `cavra-aispm-report-delivery-setup-packet.json` to show required Enterprise setup inputs, secret-reference boundaries, recipient governance, scheduling, retention, and delivery audit expectations.

AISPM report operations readiness is tracked by [AISPM report operations readiness](docs/release-verifications/aispm-report-operations-readiness.md), [AISPM report operations readiness JSON](docs/release-verifications/aispm-report-operations-readiness.json), and `scripts/validate-aispm-report-operations-readiness.py`; the AISPM portal exports `cavra-aispm-report-operations-readiness-packet.json` to show Enterprise delivery audit events, operations dashboard, retention lifecycle, search/retrieval, and signed export package manifest readiness without exposing raw report payloads or customer records.

AISPM report governance readiness is tracked by [AISPM report governance readiness](docs/release-verifications/aispm-report-governance-readiness.md), [AISPM report governance readiness JSON](docs/release-verifications/aispm-report-governance-readiness.json), and `scripts/validate-aispm-report-governance-readiness.py`; the AISPM portal exports `cavra-aispm-report-governance-readiness-packet.json` to show Enterprise schedule policy, recipient policy, approval decision, exception lifecycle, and evidence-room readiness without exposing identities, recipient addresses, private justifications, raw report content, or signed download URLs.

AISPM report assurance readiness is tracked by [AISPM report assurance readiness](docs/release-verifications/aispm-report-assurance-readiness.md), [AISPM report assurance readiness JSON](docs/release-verifications/aispm-report-assurance-readiness.json), and `scripts/validate-aispm-report-assurance-readiness.py`; the AISPM portal exports `cavra-aispm-report-assurance-readiness-packet.json` to show Enterprise evidence-room access events, incident packets, incident closure, KPI metrics, and alert escalation readiness without exposing identities, IP addresses, raw report content, private remediation details, tenant drilldowns, signed URLs, or customer records.

AISPM report response readiness is tracked by [AISPM report response readiness](docs/release-verifications/aispm-report-response-readiness.md), [AISPM report response readiness JSON](docs/release-verifications/aispm-report-response-readiness.json), and `scripts/validate-aispm-report-response-readiness.py`; the AISPM portal exports `cavra-aispm-report-response-readiness-packet.json` to show Enterprise alert operations dashboards, alert drilldowns, remediation plans, remediation closure, and closure operations readiness without exposing assignee identities, tenant alert records, raw report payloads, private remediation tasks, customer records, signed URLs, or provider responses.

AISPM report trial operations readiness is tracked by [AISPM report trial operations readiness](docs/release-verifications/aispm-report-trial-operations-readiness.md), [AISPM report trial operations readiness JSON](docs/release-verifications/aispm-report-trial-operations-readiness.json), and `scripts/validate-aispm-report-trial-operations-readiness.py`; the AISPM portal exports `cavra-aispm-report-trial-operations-readiness-packet.json` to show Enterprise executive digest, digest distribution, trial validation packet, trial operator dashboard, and operator API/view-model readiness without exposing evaluator identities, operator identities, package tokens, license keys, raw prompts, model reasoning, raw report content, provider responses, customer records, or Enterprise source.
...
and lab notebook readiness into one public-safe portal packet. See
[AISPM release evidence index](docs/release-verifications/aispm-release-evidence-index.md),
[AISPM release evidence index JSON](docs/release-verifications/aispm-release-evidence-index.json),
`scripts/validate-aispm-release-evidence-index.py`, and the downloadable
