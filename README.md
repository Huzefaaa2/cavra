...
- Final rollback drill auditor export retry planning and archive reference health checks are now documented in [docs/go-backend-rollback-drill-auditor-export-retry-archive-health.md](docs/go-backend-rollback-drill-auditor-export-retry-archive-health.md) with a new architecture diagram at [docs/diagrams/go-backend-rollback-drill-auditor-export-retry-archive-health.svg](docs/diagrams/go-backend-rollback-drill-auditor-export-retry-archive-health.svg).
