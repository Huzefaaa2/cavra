...
- Final rollback drill closure packet verification and auditor export are now documented in [docs/go-backend-rollback-drill-closure-packet-auditor-export.md](docs/go-backend-rollback-drill-closure-packet-auditor-export.md) with a new architecture diagram at [docs/diagrams/go-backend-rollback-drill-closure-packet-auditor-export.svg](docs/diagrams/go-backend-rollback-drill-closure-packet-auditor-export.svg).
