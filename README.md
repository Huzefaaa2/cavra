...
If the embedded GitHub player does not load in your browser, use the hosted backup: [Watch the introduction video on InVideo](https://ai.invideo.io/watch/cq7iExDcHvs).
