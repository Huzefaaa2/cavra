...
- Final rollback drill auditor export delivery routing and immutable archive references are now documented in [docs/go-backend-rollback-drill-auditor-export-routing-archive.md](docs/go-backend-rollback-drill-auditor-export-routing-archive.md) with a new architecture diagram at [docs/diagrams/go-backend-rollback-drill-auditor-export-routing-archive.svg](docs/diagrams/go-backend-rollback-drill-auditor-export-routing-archive.svg).
