...
- Add contract-level Go fixtures for the next high-risk release-governance metadata kinds.
- Document production release-signing operations and key rotation.
