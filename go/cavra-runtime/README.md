...
go run ./cmd/cavra-runtime --verify-evidence --evidence-log .cavra/go-daemon/evidence.jsonl --evidence-signing-key-id ci-evidence-2026-q2
go run ./cmd/cavra-runtime --lifecycle start --socket .cavra/cavra-runtime.sock --evidence-log .cavra/go-daemon/evidence.jsonl --runner-oidc-issuer https://token.actions.githubusercontent.com --runner-oidc-audience cavra-release-governance --runner-oidc-jwks-url https://token.actions.githubusercontent.com/.well-known/jwks
go run ./cmd/cavra-runtime --daemon --socket .cavra/cavra-runtime.sock --input ../../examples/go-runtime/typed-release-governance/approved-promotion.json --runner-auth-claims .cavra/go-daemon/runner-auth-claims.json --runner-auth-oidc-token-file .cavra/go-daemon/runner-oidc.jwt
```
