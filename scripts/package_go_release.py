        ...
        dist / "cavra-runtime.ci-runner-bundles.json",
        {
            ...
            "runner_script": {
                ...
                "required_environment": [
                    ...
                    "CAVRA_RUNNER_AUTH_OIDC_TOKEN",
                    "CAVRA_RUNNER_AUTH_OIDC_TOKEN_FILE",
                    "CAVRA_RUNNER_AUTH_OIDC_TOKEN_ENV",
                    "CAVRA_RUNNER_OIDC_AUTO",
                    "CAVRA_RUNNER_OIDC_ISSUER",
                    "CAVRA_RUNNER_OIDC_AUDIENCE",
                    "CAVRA_RUNNER_OIDC_JWKS",
                    "CAVRA_RUNNER_OIDC_JWKS_URL",
                    "CAVRA_AZURE_OIDC_TOKEN",
                    "CAVRA_AZURE_OIDC_REQUEST_TOKEN",
            ...
            "controls": [
                ...
                "runner-oidc-provider-token-acquisition",
                "daemon-evidence-stream-hmac-signed",
                "daemon-evidence-stream-verifier-cli",
                "evidence-verification-artifact-published",
                "runner-evidence-key-custody-documented",
            ...
            "operator_steps": [
                ...
                "Set CI-provider OIDC issuer, audience, JWKS, and provider token acquisition settings when runner JWT verification is required.",
                "Set CAVRA_DAEMON_EVIDENCE_HMAC_KEY when chained evidence signatures are required.",
                "Run cavra-runtime --verify-evidence against the daemon evidence JSONL before attaching release evidence to a change record.",
                "Follow docs/runner-auth-evidence-key-custody.md for HMAC custody, rotation, JWKS trust, and evidence-verification retention.",
